...
class _IncomeOutcomePageState extends State<IncomeOutcomePage> {
  ...
  menuOption(context, String value, History history) async {
    if (value == 'update') {
      ...
      if (yes ?? true) {
        ...
        DInfo.dialogError(context, 'Hapus history gagal');
      }
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    filled: true,
                    fillColor: AppColor.bg.withOpacity(0.5),
      ...
      body: GetBuilder<CIncomeOutcome>(builder: (_) {
        ...
        if (_.list.isEmpty) return DView.empty('Kososng');
